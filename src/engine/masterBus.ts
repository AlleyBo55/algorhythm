// Team 1: Ableton Audio Engine - Master Bus
// Professional master bus with limiting and analysis
...
export class MasterBus {
  ...
  private readonly LIMITER_THRESHOLD = -0.3; // dB
  private readonly LIMITER_RELEASE = 0.1; // seconds
